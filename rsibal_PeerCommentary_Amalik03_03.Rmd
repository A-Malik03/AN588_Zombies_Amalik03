---
title: "A-rsibal_PeerCommentary_Amalik03_03"
...
*Ritika's comments: Again great job with your code, its been very easy to follow! I liked that the plot command is all in one line. I would say that these plots (to me at least) seemed positively correlated (if not weakly), but I will leave that up to you!*
```{r}
